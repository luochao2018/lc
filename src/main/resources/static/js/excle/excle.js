...
function choice(v) {
    ...
    if (v == 2) {
        ...
        $('#w').window('close');
        // 查询,刷新数据
        $("#" + DATAGRIDE_ID).datagrid('load',getParams("form-search"));
    }
}
...
function initDataGrid(v) {
    ...
    var datagrid = $("#dg").datagrid({
        ...
        columns: [
            //一维
            [
                {field: '', title: '',width: 120, checkbox: false},
                {field: 'AGE1', title: 'AGE1',colspan:3,width: 120, halign: 'center'},
                {field: 'AGE1', title: 'AGE2',colspan:1,width: 120, halign: 'center'},
            ],
            //二维
            [
                {field: '', title: '',width: 120, checkbox: false},
                {field: 'AGE1', title: 'AGE1',colspan:2,width: 120, halign: 'center'},
                {field: 'AGE1', title: 'AGE2',colspan:2,width: 120, halign: 'center'},
            ],
            //三维
            [
                {field: '#', title: '#',width: 120,checkbox: true},
                {
                    field: 'BIRTH', title: 'BIRTH', width: 200, belong: "Q", align: 'center', sortable: true,
